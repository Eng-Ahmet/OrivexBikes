      ...
      <section class="container-xl px-3 px-md-4 mb-5">
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4 gap-2">
          <div>
            ...
            <h2 class="display-6 fw-bold text-white font-heading mb-0">Featured Vehicle Models</h2>
          </div>
          <a routerLink="/bikes" class="btn btn-outline-primary rounded-pill px-4 fw-bold">
            View All Models <i class="fa-solid fa-arrow-right me-1"></i>
          </a>
        </div>

        <div class="row g-4">
          @for (model of aggregatedModels(); track model.key) {
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card bg-dark border-secondary-subtle rounded-4 h-100 shadow-sm hover-shadow transition overflow-hidden" style="background: #111827 !important;">
                <div class="position-relative bg-secondary bg-opacity-10 text-center p-4">
                  ...
                  <!-- Kick Scooter SVG for Patinete/Scooter vs Bike Icon -->
                  <div class="d-flex align-items-center justify-content-center py-3">
                    <ng-container *ngIf="model.is_scooter; else bikeIcon">
                      <div class="p-3 bg-warning bg-opacity-10 rounded-circle d-inline-flex align-items-center justify-content-center">
                        <svg width="54" height="54" viewBox="0 0 24 24" fill="none" stroke="#f59e0b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="card-body p-4 d-flex flex-column">
                  ...
                  <div class="mt-auto d-flex gap-2">
                    <a [routerLink]="['/book']" [queryParams]="{vehicleId: model.representative_id}" class="btn btn-primary btn-sm rounded-pill w-100 fw-bold">
                      <i class="fa-solid fa-calendar-check me-1"></i> Book Model
                    </a>
                  </div>
                </div>
              </div>
